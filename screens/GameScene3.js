...
export class GameScene3 {
  constructor(container = document.body, onExit = null) {
  ...
  start() {
    ...
    const hero2 = new character("Mage", 70, 25, "assets/characters/leaf_ranger/elementals_spritesheet.png", [
      skilldatabase["Fireball"], skilldatabase["Ice"], skilldatabase["Thunder"], skilldatabase["Meteor"]
    ], "assets/characters/leaf_ranger/leaf_ranger.png");
    ...
    const boss = new character("Demon Lord", 199, 70, "assets/characters/cthulu/cthulu_spritesheet.png", []);
...
boss.animationState = "idle";
    ...
    const battle = new battlecontroller(heroParty, boss, ui, {
      ...
      onGameOver: () => {
        alert("Pertempuran berakhir. Kembali ke menu utama.");
        window.location.href = "/screens/MainMenu.html";
      }
    });
    ...
    Promise.all([
      ...
      hero2.setAnimator(new SpriteAnimator(img2, HERO_ANIMATIONS.leaf_ranger, 3));
      hero3.setAnimator(new SpriteAnimator(img3, HERO_ANIMATIONS.cristal_mauler, 3));
      boss.setAnimator(new SpriteAnimator(imgBoss, HERO_ANIMATIONS.cthulu, 3));
